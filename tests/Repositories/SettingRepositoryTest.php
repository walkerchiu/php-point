...
use WalkerChiu\Point\Models\Repositories\SettingRepository;
...
class SettingRepositoryTest extends \Orchestra\Testbench\TestCase
{
     ...
     * @return void
     */
    public function testPointRepository()
    {
        // Config
     ...
     *     WalkerChiu\Point\Models\Repositories\SettingRepository
     * 
     * @return void
     */
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_morph_1 = factory(Setting::class)->create(['is_enabled' => 1]);
        $db_morph_2 = factory(Setting::class)->create();
        $db_morph_3 = factory(Setting::class)->create();
        $db_morph_4 = factory(Setting::class)->create();
    ...
    public function testQueryList()
    {
        ...
        // Give
        $db_morph_1 = factory(Setting::class)->create();
        $db_morph_2 = factory(Setting::class)->create();
        $db_morph_3 = factory(Setting::class)->create();
        $db_morph_4 = factory(Setting::class)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Setting::class)->create(['serial' => '123']);
            $db_morph_4 = factory(Setting::class)->create(['serial' => '124']);
            $db_morph_5 = factory(Setting::class)->create(['serial' => '125', 'is_enabled' => 1]);
            // When
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        $db_morph_1 = factory(Setting::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(Setting::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
