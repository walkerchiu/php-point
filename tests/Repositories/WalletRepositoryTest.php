...
class WalletRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testWalletRepository()
    {
        ...
        $wallet_1 = $this->repository->save([
            'setting_id' => $db_setting->id,
            'user_id'    => $user_id_1,
            'value'      => $faker->randomNumber
        ]);
        $wallet_2 = $this->repository->save([
            'setting_id' => $db_setting->id,
            'user_id'    => $user_id_2,
            'value'      => $faker->randomNumber
        ]);
        $wallet_3 = $this->repository->save([
            'setting_id' => $db_setting->id,
            'user_id'    => $user_id_3,
            'value'      => $faker->randomNumber
        ]);
        ...
        // Give
        $id_list = [$wallet_1->id, $wallet_2->id, $wallet_3->id];
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_setting = factory(Setting::class)->create();
        $db_morph_1 = factory(Wallet::class)->create(['setting_id' => $db_setting->id, 'user_id' => $user_id, 'is_enabled' => 0]);
        $db_morph_2 = factory(Wallet::class)->create(['setting_id' => $db_setting->id, 'user_id' => $user_id]);
        $db_morph_3 = factory(Wallet::class)->create(['setting_id' => $db_setting->id, 'user_id' => $user_id]);
        $db_morph_4 = factory(Wallet::class)->create(['setting_id' => $db_setting->id, 'user_id' => $user_id]);
